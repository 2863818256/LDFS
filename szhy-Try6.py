...
if __name__ == '__main__':
    ...
    AllLabels = features[-14:]
    AllFeatures = features[:-14]
    ...
    if not os.path.exists('LabelDistribution2/'+DataSetName+'_conditions.csv'):
        f = open("LabelDistribution2/"+DataSetName+"_conditions.csv","w")
        f.close()
    ...
    with open('ExperimentResult/'+DataSetName+'_Result.txt','w') as fw:
